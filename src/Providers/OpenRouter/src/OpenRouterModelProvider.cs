...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.MetaLlama370BInstruct, new ChatModels("meta-llama/llama-3-70b-instruct",8192,8.000000000000001E-07,8.000000000000001E-07)},
        { OpenRouterModelIds.Wizardlm28X22b, new ChatModels("microsoft/wizardlm-2-8x22b",65536,1E-06,1E-06)},
        ...
        { OpenRouterModelIds.Mythomax13BExtended, new ChatModels("gryphe/mythomax-l2-13b:extended",8192,3E-07,3E-07)},
